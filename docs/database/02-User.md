...
## Overview
Represents the User entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage User data within the business networking SaaS platform.
