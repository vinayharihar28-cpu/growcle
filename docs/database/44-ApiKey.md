...
## Overview
Represents the ApiKey entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage ApiKey data within the business networking SaaS platform.
