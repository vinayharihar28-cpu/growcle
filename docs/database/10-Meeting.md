...
## Overview
Represents the Meeting entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage Meeting data within the business networking SaaS platform.
