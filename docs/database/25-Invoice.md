...
## Overview
Represents the Invoice entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage Invoice data within the business networking SaaS platform.
