...
## Overview
Represents the Referral entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage Referral data within the business networking SaaS platform.
