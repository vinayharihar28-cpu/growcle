...
## Overview
Represents the VisitorInvitation entity in the system. Ensures multi-tenant isolation and data integrity.

---

## Purpose
This table exists to manage VisitorInvitation data within the business networking SaaS platform.
