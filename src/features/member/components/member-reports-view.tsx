...
import { BarChart3, TrendingUp, Handshake, CheckCircle2, IndianRupee, Users } from "lucide-react";
import {
  getMemberContext,
  getMemberReports,
  MemberContext,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-border pb-4">
        <h2 className="text-2xl font-bold tracking-tight text-foreground">My Scorecard</h2>
