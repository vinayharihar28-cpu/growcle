...
import { CreditCard, IndianRupee, CheckCircle2, Clock, AlertTriangle } from "lucide-react";
              ...
              <tbody className="divide-y">
                {payments.map((p) => (
                  <tr key={p.id} className="hover:bg-muted/30">
                    ...
                    <td className="px-6 py-4 font-bold text-foreground">₹{p.amount.toLocaleString("en-IN")} {p.currency || 'INR'}</td>
